...
Circle.prototype.draw = function (ctx) {
    ctx.beginPath();
    ctx.arc(120, 120, this.radius, 0, Math.PI * 2, true);  // 坐标为120的圆，这里起始角度是0，结束角度是Math.PI*2
...
Ring.prototype.drawRing = function (ctx, startAngle, percentArray) {
    ...
    percentArray.forEach(function (item, index) {
        ...
        ctx.arc(120, 120, _this.radius, startAngle, startAngle + anglePerSec, false); //这里的圆心坐标要和cirle的保持一致
    ...
    //小圆圈覆盖
    ctx.beginPath();
    ctx.arc(120, 120, _this.radius, startAngle, startAngle, false); //这里的圆心坐标要和cirle的保持一致
