// import Ring from './cricleRoundring';
// Charts 构造函数
function Charts() {
  this.context = null;
  this.width = 720;
...
Charts.prototype.init = function(container){ // 初始化图表
...
Charts.prototype.getRadisAndRingwidth = function(radius=['100%', '0%']){ // 获取圆环的半径和环宽
...
Charts.prototype.workWithColor = function(color){ // 颜色处理
...
Charts.prototype.getPercentList = function(data){ // 获取百分比列表
    // let t = 0;
...
Charts.prototype.setOption = function(options){ // 设置图表属性
